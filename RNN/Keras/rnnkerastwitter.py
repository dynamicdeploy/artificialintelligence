...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 10 17:24:19 2017
...
#You will need to load the spacy's en module from terminal
...
# split the data into test and train using the tran_test_split function from scikitlearn
